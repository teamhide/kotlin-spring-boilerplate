package com.sample.sample.user.adapter.out.persistence

import com.sample.sample.user.adapter.out.persistence.jpa.UserFriendEntity
import com.sample.sample.user.adapter.out.persistence.jpa.UserFriendRepository
import com.sample.sample.user.application.port.out.GetUserFriendPersistencePort
import com.sample.sample.user.application.port.out.SaveUserFriendPersistencePort
